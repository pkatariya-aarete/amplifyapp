...
export class CustomSignUp extends SignUp {
  ...
  onKeyUpPasswordValidation = e => {
    ...
    if (pwd != "") {
      if (
        ...
        //msg = "Valid Password!";
        //pwdMsgElement.innerHTML = msg;
        //pwdMsgElement.className = "success-message";
        ...
        //pwdMsgElement.innerHTML = msg;
        //pwdMsgElement.className = "error-message";
        document
        ...
        .catch(err => {
          ...
          if (err.code === "UserLambdaValidationException") {
            ...
            if (err.message.includes("EmailAlreadyExist")) {
              ...
              msg =
                "The email address provided does not meet the domain criteria. <br/>Please try again.";
              this.showAlert(msg);
            }
  ...
  isDataValid() {
    ...
    //Password Special Character Check
      ...
      flag = true;
      msg =
        "Password should contain atleast 1 special characters. Please try again.";
    }
    //Password contains alphabet
      ...
      document.getElementById("password").focus();
      flag = true;
      msg = "Password should contain atleast 1 alphabet. Please try again.";
    }
